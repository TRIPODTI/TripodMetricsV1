...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { device_id: @rate.device_id, in_date: @rate.in_date, selected_option: @rate.selected_option }
    end
  ...
  test "should update rate" do
    put :update, id: @rate, rate: { device_id: @rate.device_id, in_date: @rate.in_date, selected_option: @rate.selected_option }
    assert_redirected_to rate_path(assigns(:rate))
  end
